...
class LinePlotTestCase(unittest.TestCase):
    ...
    def test_line_plot_title(self):
        ...
        self.assertEqual(actual,
                         expected,
                         "Expected line plot title to be 'Daily "
                         "freeCodeCamp Forum Page Views 5/2016-12/2019'")
    ...
    def test_line_plot_data_quatity(self):
        ...
        self.assertEqual(actual,
                         expected,
                         "Expected number of data points in line plot"
                         "to be 1238.")
...
class BarPlotTestCase(unittest.TestCase):
    ...
    def test_bar_plot_legend_labels(self):
        ...
        self.assertEqual(actual,
                         expected,
                         "Expected bar plot legend labels to be "
                         "months of the year.")
    ...
    def test_bar_plot_labels(self):
        ...
        self.assertEqual(actual,
                         expected,
                         "Expected bar plot secondary labels to be "
                         "'2016', '2017', '2018', '2019'")
...
class BoxPlotTestCase(unittest.TestCase):
    ...
    def test_box_plot_number(self):
        ...
        self.assertEqual(actual,
                         expected,
                         "Expected two box plots in figure.")
    ...
    def test_box_plot_labels(self):
        ...
        self.assertEqual(actual,
                         expected,
                         "Expected box plot 1 x-axis labels to be "
                         "'2016', '2017', '2018', '2019'")
        actual = []
        ...
        self.assertEqual(actual,
                         expected,
                         "Expected box plot 2 x-axis labels to be "
                         "'Jan', 'Feb', 'Mar', 'Apr', 'May', 'Jun', "
                         "'Jul', 'Aug', 'Sep', 'Oct', 'Nov', 'Dec'")
        actual = []
        ...
        self.assertEqual(actual,
                         expected,
                         "Expected box plot 1 y-axis labels to be '0', "
    ...
    def test_box_plot_titles(self):
        ...
        self.assertEqual(actual,
                         expected,
                         "Expected box plot 1 title to be "
                         "'Year-wise Box Plot (Trend)'")
        actual = self.ax2.get_title()
        expected = "Month-wise Box Plot (Seasonality)"
        self.assertEqual(actual,
                         expected,
                         "Expected box plot 1 title to be 'Month-wise "
    ...
    def test_box_plot_number_of_boxes(self):
        ...
        self.assertEqual(actual,
                         expected,
                         "Expected four boxes in box plot 1.")
        actual = len(self.ax2.lines) / 6  # Every box has 6 lines
        expected = 12
        self.assertEqual(actual,
                         expected,
                         "Expected 12 boxes in box plot 2.")
